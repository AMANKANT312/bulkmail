...
const Basicinfo = ({ display, data }) => {
  ...
  console.log(`this is from basicinfo ${data.title}`);
  ...
  return (
    <>
      ...
      <div className="h-[40px] flex w-full   justify-end bg-[#be3745ed]">
        <div className=" w-1/2 flex items-center justify-center gap-5 ">
          ...
          <div className="flex gap-2 w-32 justify-evenly bg-[#ffe330c1] p-1 px-2 rounded-md cursor-pointer">
            {/* <img src={fileLogo} alt="" className="w-5 " /> */}
            <p onClick={savedata}>Ok</p>
          </div>
        </div>
      </div>
    </>
