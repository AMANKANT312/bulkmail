...
const NewContactpopup = ({ display, data }) => {
  ...
  return (
    ...
    >
      <div
        className={
          " min-w-[850px]  min-h-[550px] bg-slate-50 rounded-xl overflow-hidden"
        }
      >
        <div className=" h-full">
          <div className="controlbar w-full h-8 bg-[#be3745ed] flex justify-between">
            ...
            <div className="flex justify-between w-full h-full ">
              <div className="w-3/4 h-full justify-between  flex">
                ...
                <div className="flex h-full items-end pr-16">
                  <div
                    className={
                      "butn px-2 mr-2 border-2 border-gray-500 text-black"
                    }
          ...
          <div className="content h-[453px]">
            {showbasic ? (
              <Basicinfo display={display} data={data} />
            ) : (
