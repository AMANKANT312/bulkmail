...
const Addressbook = ({ data }) => {
  ...
  return (
    <div
      className="h-full w-full realtive"
    ...
    >
      ...
      <div className="">
        <table className="w-full min-w-max table-auto text-left  pt-10 ">
          <thead>
            <tr className="">
              {TABLE_HEAD.map((head) => (
                <th key={head} className=" bg-blue-gray-50 p-2">
                  <div
                    variant="small"
                    color="blue-gray"
      ...
      {context ? (
        <div
          className="addresscontext absolute top-0 z-10 border-2 text-white px-2 bg-slate-900 w-64 rounded-md"
